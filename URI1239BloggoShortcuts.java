...
/**
 * See <a href="https://www.urionlinejudge.com.br/judge/en/problems/view/">URI1239BloggoShortcuts</a>
 * @author Brian Yeicol Restrepo Tangarife
 */
public class URI1239BloggoShortcuts {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((l = in.nextLine()) != null) {
            l = l.replaceAll("_([^_]*)_", "<i>$1</i>");
            l = l.replaceAll("\\*([^*]*)\\*", "<b>$1</b>");
            out.println(l);
        }
        in.close();
        out.flush();
